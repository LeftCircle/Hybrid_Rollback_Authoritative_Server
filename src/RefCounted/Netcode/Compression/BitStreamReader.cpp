...
// void BitStreamReader::init_read(BitStream &bit_stream, PackedByteArray new_buffer)
// {
...
// int BitStreamReader::read(BitStream &bit_stream, int x_bits)
// {
...
// bool BitStreamReader::is_finished(BitStream &bit_stream)
// {
// 	assert(bit_stream.read_bits <= bit_stream.total_bits);
// 	return bit_stream.read_bits == bit_stream.total_bits;
// }

// void BitStreamReader::read_word(BitStream &bit_stream)
// {
...
// Array BitStreamReader::decompress_int_array(BitStream &bit_stream, bool is_signed)
// {
...
// Variant BitStreamReader::variable_decompress(BitStream &bit_stream, Variant::Type type, bool is_signed)
// {
...
// int BitStreamReader::decompress_int(BitStream &bit_stream, int inBitCount, bool is_signed)
// {
// 	if (is_signed)
// 	{
...
// Vector2 BitStreamReader::decompress_vector(BitStream &bit_stream, int bits_per_component, bool is_signed)
// {
...
// float BitStreamReader::decompress_float(BitStream &bit_stream, int inBitCount, bool is_signed, int n_decimals)
// {
// 	int float_as_int = decompress_int(bit_stream, inBitCount, is_signed);
// 	return float(float_as_int) / pow(10.0, n_decimals);
// }

// Vector2 BitStreamReader::decompress_unit_vector(BitStream &bit_stream)
// {
...
// int BitStreamReader::decompress_class_id(BitStream &bit_stream)
// {
// 	return read(bit_stream, BitStream::N_CLASS_ID_BITS);
// }

// int BitStreamReader::decompress_instance_id(BitStream &bit_stream)
// {
// 	return read(bit_stream, BitStream::N_CLASS_INSTANCE_BITS);
// }

// int BitStreamReader::decompress_frame(BitStream &bit_stream)
// {
// 	return read(bit_stream, BitStream::BITS_FOR_FRAME);
// }

// bool BitStreamReader::decompress_bool(BitStream &bit_stream)
// {
// 	return bool(read(bit_stream, 1));
// }

// Vector2 BitStreamReader::decompress_quantized_input_vec(BitStream &bit_stream)
// {
